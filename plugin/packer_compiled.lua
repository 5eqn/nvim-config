...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-nvim-lsp", "cmp-buffer", "cmp-nvim-ultisnips", "cmp-emoji", "cmp-omni" },
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'which-key.nvim', 'unicode.vim', 'lspkind-nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
